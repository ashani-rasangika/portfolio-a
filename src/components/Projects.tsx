...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      githubLink: "#",
      duration: "3 months",
      team: "Team Project (Academic) – Project Leader",
      features: [
        "AI Virtual Mentor",
    ...
    },
    {
      ...
      category: "university",
      description:
        "A comprehensive waste management mobile application promoting environmental sustainability. Features waste tracking, recycling points system, and educational content about proper waste disposal.",
    ...
    },
    {
      ...
      category: "university",
      description:
        "A specialized e-commerce platform for herbal products developed as a university project. Features user authentication, product management, and secure payment integration with Google Sign-in.",
    ...
    },
    {
      ...
      category: "university",
      description:
        "A comprehensive travel planning platform for Sri Lankan tourism developed as a university project. Features safe travel options, secure payments, loyalty points system, and 24/7 customer support.",
